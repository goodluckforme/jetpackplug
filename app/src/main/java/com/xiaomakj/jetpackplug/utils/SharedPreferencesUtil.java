...
import com.xiaomakj.gtshop.common.SP;
...
public class SharedPreferencesUtil {
    ...
    public void removeUser() {
        SharedPreferencesUtil.getInstance().remove(SP.Token.getValue());
        SharedPreferencesUtil.getInstance().remove(SP.UserInfo.getValue());
    }
}
